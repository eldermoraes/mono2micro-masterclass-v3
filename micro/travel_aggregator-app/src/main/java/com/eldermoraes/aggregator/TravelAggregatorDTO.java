...
public class TravelAggregatorDTO {
    ...
    public static TravelAggregatorDTO of (long travelOrderId, String toAirport,
                                          String fromAirport, Integer nights){
        return new TravelAggregatorDTO(travelOrderId, toAirport, fromAirport, nights);
    }

    public static TravelAggregatorDTO of (TravelOrder travelOrder, TravelFlight travelFlight,
        ...
        return new TravelAggregatorDTO(travelOrder.getId(), travelFlight.getToAirport(),
                travelFlight.getFromAirport(), travelHotel.getNights());
    }
